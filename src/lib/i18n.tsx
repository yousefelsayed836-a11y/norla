...
const translations = {
  en: {
    ...
    "checkout.vodafoneFee": "Vodafone Cash service fee",
    "nav.exchangePolicy": "Exchange Policy",
    ...
    "order.vodafoneFee": "Vodafone Cash fee",
    "order.total": "Total",
    "order.deposit": "Deposit due now",
    "order.payVia": "Pay via",
    "order.instapay": "InstaPay",
  ...
  ar: {
    ...
    "checkout.vodafoneFee": "رسوم خدمة فودافون كاش",
    "nav.exchangePolicy": "سياسة الاستبدال",
    "policy.exchangeTitle": "سياسة الاسترداد",
    ...
    "order.vodafoneFee": "رسوم فودافون كاش",
    "order.total": "الإجمالي",
    "order.deposit": "العربون المطلوب الآن",
    "order.payVia": "الدفع عبر",
    "order.instapay": "InstaPay",
