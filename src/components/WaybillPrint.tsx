    ...
    <div>
      <style>{`
        ...
        @media print {
          ...
          html, body { margin: 0; padding: 0; width: 100mm; height: 150mm; }
        }
      `}</style>
      ...
      <div
        dir="rtl"
        className="bg-white text-black font-jost font-bold flex flex-col text-[10px] border border-black"
        style={{
          width: "100mm",
          height: "150mm",
          padding: "0.25cm",
        ...
        <table className="w-full border-collapse text-[9px]" style={{ tableLayout: "fixed" }}>
          <tbody>
            <tr>
              ...
              <td className="border border-black p-1 w-[28%] font-bold">اسم الراسل:</td>
              <td className="border border-black p-1">{SENDER_NAME}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 font-bold">رقم الراسل:</td>
            ...
            <tr>
              ...
              <td className="border border-black p-1 font-bold">اسم المستلم:</td>
              <td className="border border-black p-1">{receiverName}</td>
            </tr>
            <tr>
              <td className="border border-black p-1 font-bold">رقم المستلم:</td>
              <td className="border border-black p-1" dir="ltr">
                {phone1}
              </td>
            </tr>
